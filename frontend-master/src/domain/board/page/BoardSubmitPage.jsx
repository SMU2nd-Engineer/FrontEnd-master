...
const BoardSubmitPage = () => {
  ...
  const [ submitData, setSubmitDatas ] = useState([]); // 게시글 등록 
  const [ quillCustomData, setQuillCustomData ] = useState (""); // 툴바 커스텀
  ...
  return (
    <div className='new_board_submit'>
      ...
      {/* 글 내용 입력하는 창 */}
      <p>글 내용</p>
      <BoardEditorQuill quillCustomData={quillCustomData} setQuillCustomData={setQuillCustomData}/>
