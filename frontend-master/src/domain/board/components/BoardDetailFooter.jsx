...
import {getBoardComment, postBoardDeleteComment, postBoardAddComment} from "../services/boardService"

const BoardDetailFooter = ({
  newCommentText, setNewCommentText, commentList, setCommentList, id, setLoading}) => {
            ...
            return (
              <li key={safeKey}>
                  ...
                  */}
                  ...
                  <button onClick={()=> {handleDelete(comment.comment_idx)}}>댓글 삭제</button>
                  {/* } */}
                </li>
              );
          })}
